...
public class Token implements Serializable {
    ...
    public String toString() {
        return "Token{" + "ip=" + ip + ", puerto_escucha=" + puerto_escucha + ", puerto_envio=" + puerto_envio + ", id_proceso=" + id_proceso + ", hora_levantamiento=" + hora_levantamiento + ", ultima_hora_funcionamiento=" + ultima_hora_funcionamiento + '}';
    }
